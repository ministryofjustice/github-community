...
from app.projects.repository_standards.services.circleci_service import (
...
def owner_dashboard(owner: str):
    ...
    return render_template(
        "projects/repository_standards/pages/owner_dashboard.html",
        owner=owner,
...
def owner_dashboard_all_repositories(owner: str):
    ...
    repositories_compliance_map = get_repositories_compliance_map(repositories)
    return render_template(
        "projects/repository_standards/pages/owner_dashboard_all_repositories.html",
        owner=owner,
        repositories=repositories,
...
def owner_dashboard_repositories_without_admin_access(owner: str):
    ...
    return render_template(
        "projects/repository_standards/pages/owner_dashboard_repositories_without_admin_access.html",
        owner=owner,
        repositories=repositories,
    )
...
def owner_dashboard_non_compliant_repositories_report(owner: str):
    ...
    return render_template(
        "projects/repository_standards/pages/owner_dashboard_non_compliant_repositories_report.html",
        owner=owner,
        repositories=repositories,
        repositories_compliance_map=repositories_compliance_map,
    )
...
def owner_dashboard_circleci(owner: str):
    ...
    return render_template(
        "projects/repository_standards/pages/owner_dashboard_circleci.html",
        owner=owner,
